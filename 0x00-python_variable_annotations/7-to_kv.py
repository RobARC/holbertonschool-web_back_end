...
def to_kv(k: str, v: Union[int, float]) -> Tuple[str, float]:
    """ Method to_kv receive two parameters a str and other that could be a int or float,
        return a tuple wich first argument is a str a the second is a square of v type float
    """
